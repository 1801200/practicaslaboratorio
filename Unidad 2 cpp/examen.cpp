...
const string USERS[] = {"david", "hanna", "alfredo"}; // arreglo para usuarios
const string PASSWORDS[] = {"2007", "hola23", "ingresa"}; // areglo para password
...
int main(){
	...
	do{
			char opc;
    cout<<"bienvenidos a nuestros codigos";
    cout<<"A Vocal"<<endl;
    cout<<"B 1a100"<<endl;
